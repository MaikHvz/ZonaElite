...
- **Estado**: Implementado. Suite secciones A–AA en verde (542 tests), `npx tsc --noEmit` limpio, `npm run build` OK. Requisito/detalle en `contexto/requisitos/tienda-carrito-ventas.md`.
