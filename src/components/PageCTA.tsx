  ...
  return (
    <section className="py-[64px] md:py-[96px] relative overflow-hidden fade-up">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-5 text-center">
        ...
        <Link href="/horarios" className="inline-block btn-primary-gradient text-white font-[family-name:var(--font-headline-md)] text-xl px-12 py-5 rounded-[0.25rem] uppercase tracking-widest hover:scale-105 transition-transform duration-300 shadow-[0_0_40px_rgba(229,57,53,0.4)]">
          Reservar Clase
        </Link>
      </div>
    </section>
